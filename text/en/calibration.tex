...
\todo[inline]{R: Tento odstavec nedava moc smysl}
...
\todo[inline]{R:Nehodil by se obrazek, ktery to nazorne ukaze}
...
information about their relative position to each other. 
\todo[inline]{co je relative position}
